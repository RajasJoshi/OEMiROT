...
#define FLASH_AREA_1_OFFSET            0x30000  /* Non-secure app image primary slot offset */

#define FLASH_AREA_1_SIZE              0xA0000   /* Non-secure app image primary slot size */

#define FLASH_AREA_2_OFFSET            0xD2000  /* Secure app image secondary slot */

#define FLASH_AREA_2_SIZE              0x6000   /* Secure app image secondary slot size */

#define FLASH_AREA_3_OFFSET            0xD8000  /* Non-secure app image secondary slot offset */
...
#define FLASH_AREA_5_OFFSET            0xD0000  /* Non-secure data image primary slot offset */

#define FLASH_AREA_5_SIZE              0x2000   /* Non-secure data image primary slot size */

#define FLASH_AREA_6_OFFSET            0x178000 /* secure data image secondary slot offset */

#define FLASH_AREA_6_SIZE              0x2000   /* secure data image secondary slot size */

#define FLASH_AREA_7_OFFSET            0x17A000 /* Non-secure data image secondary slot offset */

#define FLASH_AREA_7_SIZE              0x2000   /* Non-secure data image secondary slot size */
